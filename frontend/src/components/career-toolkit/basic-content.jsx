...
export default function BasicContent({ pageView }) {
    ...
    <div className="pt-8 transition-all duration-[2000ms] ease-in-out">
      ...
      <div className="text-center font-light text-[48px] leading-[60px] mb-12">
        ...
        <h2 className="font-medium text-[#2A254D]">
          BASIC PROJECTS <span className="text-[#ff6600]">CLOUD & DEVOPS</span>
        </h2>
      ...
      >
        <h2 className="text-center font-semibold text-[64px] mb-8 leading-[70px] text-[#2A254D] mx-5">
          <span className="text-[#ff6600]">Top 5 DevOps & Cloud Projects</span>{" "}
          Every  {" "}
          {/* <br /> */}
          beginner should have in there
          {/* <br /> */} {" "}
          Resume
        </h2>
        <p
          className={cn(
            "text-center font-medium text-[#363258] mb-12 text-[20px] leading-[24px] px-6",
        ...
        <div className="text-center my-8">
          <Button className="lg:px-12 md:px-8 px-6 rounded-[100px] mt-4 py-6 bg-[#ff6600] hover:bg-[#ff6600]/90 text-[16px]">
            Get Access To All BASIC PROJECTS →
          </Button>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="border-2 border-[#ff6600] rounded-xl p-6 bg-[linear-gradient(180deg,#FCE7D0_0%,#FFF_63.5%)]">
            <h3 className="text-[32px] font-semibold mb-4 text-[#363258]">
              Who is this <span className="text-[#ff6600]">Basic Projects</span>{" "}
              for?
            </h3>
